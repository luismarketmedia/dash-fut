...
import { Minus, Plus, Square, Star } from "lucide-react";
				...
				<div className="container flex h-16 items-center justify-between">
					...
					<div className="flex items-center gap-6">
						...
						<div className="flex items-center gap-3">
							...
							<Button size="sm" variant="outline" onClick={() => resetTimer(match.id)}>
								Resetar
							</Button>
							<Button size="sm" variant="secondary" onClick={() => nextHalf(match.id)}>
								Próximo tempo
							</Button>
						</div>
					</div>
							...
							>
									...
									<Input
										...
										onChange={(e) =>
											dispatch({
												...
												payload: {
													...p,
													jerseyNumber: parseInt(e.target.value || "0", 10),
												},
											})
										}
									/>
								...
								<div className="flex items-center gap-4">
									...
									<Button
										...
										onClick={() => update(p.id, (prev: any) => ({ ...prev, red: !prev.red }))}
									>
